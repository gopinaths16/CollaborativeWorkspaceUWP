...
CREATE TABLE CW_BOARD_GROUP_DETAILS (ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME Text, PROJECT_ID bigint, FOREIGN KEY(PROJECT_ID) REFERENCES CW_PROJECT_DETAILS(ID));
CREATE TABLE CW_GROUP_DETAILS (ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME Text, BOARD_GROUP_ID bigint, PROJECT_ID bigint, FOREIGN KEY(BOARD_GROUP_ID) REFERENCES CW_BOARD_GROUP_DETAILS(ID), FOREIGN KEY(PROJECT_ID) REFERENCES CW_PROJECT_DETAILS(ID));
